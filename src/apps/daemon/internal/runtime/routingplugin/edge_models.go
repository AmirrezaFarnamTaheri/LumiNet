...
// ProviderRouteReadiness is the canonical scanner readiness contract, exposed
// here for routing compatibility. New implementations should use scanner
// terminology directly.
type ProviderRouteReadiness = scanner.ProviderRouteReadiness

type ConnectivitySnapshotter = scanner.ConnectivitySnapshotter
type ConnectivitySnapshot = scanner.ConnectivitySnapshot
