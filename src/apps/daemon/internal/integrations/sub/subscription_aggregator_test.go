...
// Ported 2026-08-24 from internal/runtime/proxy/subscription_aggregator_test.go:
// the aggregator implementation moved here during the consolidation waves while
// its characterization test stayed behind against the old owner.
...
func TestAggregateSubscriptions(t *testing.T) {
	...
	// Trojan is blocked by the protocol allow-list and by MinPort (80 < 100).
	// VLESS (443, "VlessTest") and VMess (8080, "VMessTest") pass all filters.
	if len(configs) != 2 {
