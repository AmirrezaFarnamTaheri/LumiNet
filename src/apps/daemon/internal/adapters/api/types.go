...
type SystemStatusResponse struct {
	...
	ConfigMutationRetry   config.MutationStats       `json:"config_mutation_retry"`
	RemoteMutationRetry   remoteaction.ExecutorStats `json:"remote_mutation_retry"`
	WebSocketBackpressure WebSocketStats             `json:"websocket_backpressure"`
}
