...
// diagPhases is a comma-separated list of phases to run (1-8).
...
var diagnoseCmd = &cobra.Command{
	Use:   "diagnose",
	Short: "Diagnose Network (Workflow 1: Run baseline, DNS, TLS, HTTP, and SNI diagnostics)",
	Long: `Runs a comprehensive network diagnostic as part of the Diagnose Network workflow, covering:
