...
export class MultipathFallbackRouter {
  private readonly tiers: FallbackTier[] = [
    ...
    { type: FallbackTierType.DomainFronted, consecutiveFailures: 0, maxFailures: 3 },
    { type: FallbackTierType.EncryptedTunnel, consecutiveFailures: 0, maxFailures: 3 },
    { type: FallbackTierType.QuicFallback, consecutiveFailures: 0, maxFailures: 5 }
  ];
