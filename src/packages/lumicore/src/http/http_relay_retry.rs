...
// Items 1-100: HTTP relay retry properties and structs
#[derive(Debug, Default)]
pub struct HttpRelayRetry {
    // Group 1: State monitoring flags (Items 1-15)
    pub is_retry_active: bool,              // Item 1
    pub retry_attempts_count: u64,          // Item 2
    pub max_retry_attempts: u32,            // Item 3
    pub backoff_factor_limit: usize,        // Item 4
    pub initial_retry_interval_millis: u64, // Item 5
    pub max_retry_interval_millis: u64,     // Item 6
    pub jitter_range_millis: u64,           // Item 7
    pub total_bytes_retried: u64,           // Item 8
    pub total_retry_cycles: u64,            // Item 9
    pub total_retry_errors: u64,            // Item 10
    pub retry_policy_name: String,          // Item 11
    pub retry_version_major: u8,            // Item 12
    pub retry_version_minor: u8,            // Item 13
    pub retry_protocol: String,             // Item 14
    pub is_secure_retry: bool,              // Item 15

    // Group 2: Atomic stats counters (Items 16-30)
    pub atomic_active_retries: AtomicI32,       // Item 16
    ...
    pub is_http_relay_retry_shutdown: bool, // Item 100
    pub is_http_relay_retry_diagnostics_shutdown: bool,
    pub is_http_relay_retry_diagnostics_helper_shutdown: bool,
    pub is_http_relay_retry_diagnostics_tuning_shutdown: bool,
    pub is_http_relay_retry_diagnostics_tuning_helper_shutdown: bool,
    pub is_http_relay_retry_helper_shutdown: bool,
    pub is_http_relay_retry_tuning_shutdown: bool,
    pub is_http_relay_retry_tuning_helper_shutdown: bool,
}
...
impl HttpRelayRetry {
    pub fn new() -> Self {
        Self {
            ...
            backoff_factor_limit: 2,
            initial_retry_interval_millis: 1000,
            max_retry_interval_millis: 30000,
            jitter_range_millis: 100,
            total_bytes_retried: 0,
            total_retry_cycles: 0,
            total_retry_errors: 0,
            retry_policy_name: "HttpRelayRetry/1.0".to_string(),
            retry_version_major: 1,
            retry_version_minor: 1,
            retry_protocol: "websocket".to_string(),
            is_secure_retry: false,
            atomic_active_retries: AtomicI32::new(0),
            ...
            custom_user_agent: "luminet-retry".to_string(),
            ...
            is_http_relay_retry_shutdown: false,
            is_http_relay_retry_diagnostics_shutdown: false,
            is_http_relay_retry_diagnostics_helper_shutdown: false,
            is_http_relay_retry_diagnostics_tuning_shutdown: false,
            is_http_relay_retry_diagnostics_tuning_helper_shutdown: false,
            is_http_relay_retry_helper_shutdown: false,
            is_http_relay_retry_tuning_shutdown: false,
            is_http_relay_retry_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_RELAY_RETRY_INITIALIZED: AtomicBool = AtomicBool::new(false);
