...
// Items 1-100: HTTP relay connection properties and structs
#[derive(Debug, Default)]
pub struct HttpRelayConnection {
    ...
    pub is_http_relay_connection_shutdown: bool, // Item 100
    pub is_http_relay_connection_diagnostics_shutdown: bool,
    pub is_http_relay_connection_diagnostics_helper_shutdown: bool,
    pub is_http_relay_connection_diagnostics_tuning_shutdown: bool,
    pub is_http_relay_connection_diagnostics_tuning_helper_shutdown: bool,
    pub is_http_relay_connection_helper_shutdown: bool,
    pub is_http_relay_connection_tuning_shutdown: bool,
    pub is_http_relay_connection_tuning_helper_shutdown: bool,
}

impl HttpRelayConnection {
    pub fn new() -> Self {
        Self {
            ...
            is_http_relay_connection_shutdown: false,
            is_http_relay_connection_diagnostics_shutdown: false,
            is_http_relay_connection_diagnostics_helper_shutdown: false,
            is_http_relay_connection_diagnostics_tuning_shutdown: false,
            is_http_relay_connection_diagnostics_tuning_helper_shutdown: false,
            is_http_relay_connection_helper_shutdown: false,
            is_http_relay_connection_tuning_shutdown: false,
            is_http_relay_connection_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_RELAY_CONNECTION_INITIALIZED: AtomicBool = AtomicBool::new(false);
