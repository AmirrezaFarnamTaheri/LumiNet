...
// Items 1-100: HTTP relay buffer properties and structs
#[derive(Debug, Default)]
pub struct HttpRelayBuffer {
    ...
    pub is_http_relay_buffer_shutdown: bool, // Item 100
    pub is_http_relay_buffer_diagnostics_shutdown: bool,
    pub is_http_relay_buffer_diagnostics_helper_shutdown: bool,
    pub is_http_relay_buffer_diagnostics_tuning_shutdown: bool,
    pub is_http_relay_buffer_diagnostics_tuning_helper_shutdown: bool,
    pub is_http_relay_buffer_helper_shutdown: bool,
    pub is_http_relay_buffer_tuning_shutdown: bool,
    pub is_http_relay_buffer_tuning_helper_shutdown: bool,
}

impl HttpRelayBuffer {
    pub fn new() -> Self {
        Self {
            ...
            buffer_allocator_name: "HttpRelayBuffer/1.0".to_string(),
            ...
            is_http_relay_buffer_shutdown: false,
            is_http_relay_buffer_diagnostics_shutdown: false,
            is_http_relay_buffer_diagnostics_helper_shutdown: false,
            is_http_relay_buffer_diagnostics_tuning_shutdown: false,
            is_http_relay_buffer_diagnostics_tuning_helper_shutdown: false,
            is_http_relay_buffer_helper_shutdown: false,
            is_http_relay_buffer_tuning_shutdown: false,
            is_http_relay_buffer_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_RELAY_BUFFER_INITIALIZED: AtomicBool = AtomicBool::new(false);
