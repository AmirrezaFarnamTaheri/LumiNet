...
pub struct MitmFrontingDiagnostics {
    ...
    pub is_fronting_diagnostics_shutdown: bool, // Item 100
}

impl MitmFrontingDiagnostics {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_diagnostics_shutdown: false,
        }
    }
}
pub static IS_FRONTING_DIAGNOSTICS_INITIALIZED: AtomicBool = AtomicBool::new(false);
