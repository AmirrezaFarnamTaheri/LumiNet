...
pub struct MitmFrontingHelper {
    ...
    pub is_fronting_helper_shutdown: bool,  // Item 100
}

impl MitmFrontingHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
