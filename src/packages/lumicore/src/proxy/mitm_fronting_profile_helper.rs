...
pub struct MitmFrontingProfileHelper {
    ...
    pub is_fronting_profile_helper_shutdown: bool, // Item 100
}

impl MitmFrontingProfileHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_profile_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_PROFILE_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
