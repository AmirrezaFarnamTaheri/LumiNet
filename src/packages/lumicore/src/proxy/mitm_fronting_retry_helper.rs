...
// Items 1-100: MITM fronting retry helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingRetryHelper {
    ...
    pub is_fronting_retry_helper_shutdown: bool, // Item 100
}

impl MitmFrontingRetryHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_retry_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_RETRY_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
