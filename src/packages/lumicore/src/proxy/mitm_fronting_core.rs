...
pub struct MitmFrontingCore {
    ...
    pub is_fronting_engine_shutdown: bool,  // Item 100
}

impl MitmFrontingCore {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_engine_shutdown: false,
        }
    }
}
pub static IS_FRONTING_CORE_INITIALIZED: AtomicBool = AtomicBool::new(false);
