...
pub struct MitmFrontingTuning {
    ...
    pub is_fronting_tuning_shutdown: bool,  // Item 100
}

impl MitmFrontingTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
