...
// Items 1-100: Core MITM Fronting session tuning helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingSessionTuningHelper {
    ...
    pub is_fronting_session_tuning_helper_shutdown: bool, // Item 100
}

impl MitmFrontingSessionTuningHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_session_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_SESSION_TUNING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
