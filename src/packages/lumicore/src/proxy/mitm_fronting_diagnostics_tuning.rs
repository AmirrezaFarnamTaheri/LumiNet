...
pub struct MitmFrontingDiagnosticsTuning {
    ...
    pub is_fronting_diagnostics_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingDiagnosticsTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_diagnostics_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_DIAGNOSTICS_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
