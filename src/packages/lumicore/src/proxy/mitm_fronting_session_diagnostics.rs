...
// Items 1-100: Core MITM Fronting session diagnostics properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingSessionDiagnostics {
    ...
    pub is_fronting_session_diagnostics_shutdown: bool, // Item 100
}

impl MitmFrontingSessionDiagnostics {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_session_diagnostics_shutdown: false,
        }
    }
}
pub static IS_FRONTING_SESSION_DIAGNOSTICS_INITIALIZED: AtomicBool = AtomicBool::new(false);
