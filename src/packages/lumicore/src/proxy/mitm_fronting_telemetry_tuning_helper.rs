...
// Items 1-100: Core MITM Fronting telemetry tuning helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTelemetryTuningHelper {
    ...
    pub is_fronting_telemetry_tuning_helper_shutdown: bool, // Item 100
}

impl MitmFrontingTelemetryTuningHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_telemetry_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TELEMETRY_TUNING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
