...
// Items 1-100: MITM fronting telemetry diagnostics properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTelemetryDiagnostics {
    ...
    pub is_fronting_telemetry_diagnostics_shutdown: bool, // Item 100
}

impl MitmFrontingTelemetryDiagnostics {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_telemetry_diagnostics_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TELEMETRY_DIAGNOSTICS_INITIALIZED: AtomicBool = AtomicBool::new(false);
