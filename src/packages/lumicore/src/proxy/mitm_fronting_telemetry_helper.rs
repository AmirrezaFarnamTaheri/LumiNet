...
// Items 1-100: Core MITM Fronting telemetry helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTelemetryHelper {
    ...
    pub is_fronting_telemetry_helper_shutdown: bool, // Item 100
}

impl MitmFrontingTelemetryHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_telemetry_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TELEMETRY_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
