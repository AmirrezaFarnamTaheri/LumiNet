...
// Items 1-100: Core MITM Fronting flow control tuning helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingFlowControlTuningHelper {
    ...
    pub is_fronting_flow_control_tuning_helper_shutdown: bool, // Item 100
}

impl MitmFrontingFlowControlTuningHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_flow_control_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_FLOW_CONTROL_TUNING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
