...
// Items 1-100: Core MITM Fronting traffic shaper helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTrafficShaperHelper {
    ...
    pub is_fronting_traffic_shaper_helper_shutdown: bool, // Item 100
}

impl MitmFrontingTrafficShaperHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_traffic_shaper_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TRAFFIC_SHAPER_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
