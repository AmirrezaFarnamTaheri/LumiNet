...
pub struct MitmFrontingRetryTuningHelper {
...
impl MitmFrontingRetryTuningHelper {
    pub fn new() -> Self {
        Self {
...
pub static IS_FRONTING_RETRY_TUNING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
