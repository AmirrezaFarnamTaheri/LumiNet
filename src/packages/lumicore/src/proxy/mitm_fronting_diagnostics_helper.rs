...
pub struct MitmFrontingDiagnosticsHelper {
    ...
    pub is_fronting_diagnostics_helper_shutdown: bool, // Item 100
}

impl MitmFrontingDiagnosticsHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_diagnostics_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_DIAGNOSTICS_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
