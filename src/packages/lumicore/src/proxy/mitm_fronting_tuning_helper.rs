...
pub struct MitmFrontingTuningHelper {
    ...
    pub is_fronting_tuning_helper_shutdown: bool, // Item 100
}

impl MitmFrontingTuningHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TUNING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
