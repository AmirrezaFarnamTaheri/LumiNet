...
// Items 1-100: Core MITM Fronting flow control helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingFlowControlHelper {
    ...
    pub is_fronting_flow_control_helper_shutdown: bool, // Item 100
}

impl MitmFrontingFlowControlHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_flow_control_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_FLOW_CONTROL_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
