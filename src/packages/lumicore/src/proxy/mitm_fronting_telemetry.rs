...
// Items 1-100: Core MITM Fronting telemetry properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTelemetry {
    ...
    pub is_fronting_telemetry_shutdown: bool, // Item 100
}

impl MitmFrontingTelemetry {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_telemetry_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TELEMETRY_INITIALIZED: AtomicBool = AtomicBool::new(false);
