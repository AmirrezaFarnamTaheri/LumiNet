...
// Items 1-100: Core MITM Fronting traffic shaper tuning properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTrafficShaperTuning {
    ...
    pub is_fronting_traffic_shaper_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingTrafficShaperTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_traffic_shaper_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TRAFFIC_SHAPER_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
