...
// Items 1-100: Core MITM Fronting session tuning properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingSessionTuning {
    ...
    pub is_fronting_session_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingSessionTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_session_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_SESSION_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
