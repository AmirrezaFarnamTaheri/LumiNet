...
// Items 1-100: MITM fronting telemetry diagnostics helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTelemetryDiagnosticsHelper {
    ...
    pub is_fronting_telemetry_diagnostics_helper_shutdown: bool, // Item 100
}

impl MitmFrontingTelemetryDiagnosticsHelper {
    pub fn new() -> Self {
        Self {
            ...
            retry_policy_name: "MitmFrontingTelemetry/1.0".to_string(),
            ...
            custom_user_agent: "luminet-telemetry".to_string(),
            ...
            is_fronting_telemetry_diagnostics_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TELEMETRY_DIAGNOSTICS_HELPER_INITIALIZED: AtomicBool =
