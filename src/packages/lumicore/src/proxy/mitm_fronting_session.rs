...
// Items 1-100: Core MITM Fronting session properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingSession {
    ...
    pub is_fronting_session_shutdown: bool, // Item 100
}

impl MitmFrontingSession {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_session_shutdown: false,
        }
    }
}
pub static IS_FRONTING_SESSION_INITIALIZED: AtomicBool = AtomicBool::new(false);
