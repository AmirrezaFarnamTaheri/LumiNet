...
// Items 1-100: Core MITM Fronting flow control properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingFlowControl {
    ...
    pub is_fronting_flow_control_shutdown: bool, // Item 100
}

impl MitmFrontingFlowControl {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_flow_control_shutdown: false,
        }
    }
}
pub static IS_FRONTING_FLOW_CONTROL_INITIALIZED: AtomicBool = AtomicBool::new(false);
