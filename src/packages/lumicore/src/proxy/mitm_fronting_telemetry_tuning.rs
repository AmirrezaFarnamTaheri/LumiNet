...
// Items 1-100: Core MITM Fronting telemetry tuning properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTelemetryTuning {
    ...
    pub is_fronting_telemetry_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingTelemetryTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_telemetry_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TELEMETRY_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
