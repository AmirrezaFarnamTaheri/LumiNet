...
// Items 1-100: Core MITM Fronting traffic shaper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingTrafficShaper {
    ...
    pub is_fronting_traffic_shaper_shutdown: bool, // Item 100
}

impl MitmFrontingTrafficShaper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_traffic_shaper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_TRAFFIC_SHAPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
