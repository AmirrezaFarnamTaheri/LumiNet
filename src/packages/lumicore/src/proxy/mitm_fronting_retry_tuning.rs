...
// Items 1-100: MITM fronting retry tuning properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingRetryTuning {
    ...
    pub is_fronting_retry_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingRetryTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_retry_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_RETRY_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
