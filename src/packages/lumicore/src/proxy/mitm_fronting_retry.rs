...
// Items 1-100: MITM fronting retry properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingRetry {
    ...
    pub is_fronting_retry_shutdown: bool,   // Item 100
}

impl MitmFrontingRetry {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_retry_shutdown: false,
        }
    }
}
pub static IS_FRONTING_RETRY_INITIALIZED: AtomicBool = AtomicBool::new(false);
