...
// Items 1-100: MITM fronting retry diagnostics properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingRetryDiagnostics {
    ...
    pub is_fronting_retry_diagnostics_shutdown: bool, // Item 100
}

impl MitmFrontingRetryDiagnostics {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_retry_diagnostics_shutdown: false,
        }
    }
}
pub static IS_FRONTING_RETRY_DIAGNOSTICS_INITIALIZED: AtomicBool = AtomicBool::new(false);
