...
// Items 1-100: MITM fronting retry diagnostics helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingRetryDiagnosticsHelper {
    ...
    pub is_fronting_retry_diagnostics_helper_shutdown: bool, // Item 100
}

impl MitmFrontingRetryDiagnosticsHelper {
    pub fn new() -> Self {
        Self {
            ...
            retry_policy_name: "MitmFrontingRetry/1.0".to_string(),
            ...
            is_fronting_retry_diagnostics_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_RETRY_DIAGNOSTICS_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
