...
// Items 1-100: Core MITM Fronting session helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingSessionHelper {
    ...
    pub is_fronting_session_helper_shutdown: bool, // Item 100
}

impl MitmFrontingSessionHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_session_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_SESSION_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
