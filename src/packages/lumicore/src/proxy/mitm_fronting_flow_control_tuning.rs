...
// Items 1-100: Core MITM Fronting flow control tuning properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingFlowControlTuning {
    ...
    pub is_fronting_flow_control_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingFlowControlTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_flow_control_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_FLOW_CONTROL_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
