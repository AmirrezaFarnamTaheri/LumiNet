...
// Items 1-100: Core MITM Fronting session diagnostics helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingSessionDiagnosticsHelper {
    ...
    pub is_fronting_session_diagnostics_helper_shutdown: bool, // Item 100
}

impl MitmFrontingSessionDiagnosticsHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_session_diagnostics_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_SESSION_DIAGNOSTICS_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
