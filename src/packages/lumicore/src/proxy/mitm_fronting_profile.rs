...
pub struct MitmFrontingProfile {
    ...
    pub is_fronting_profile_shutdown: bool, // Item 100
}

impl MitmFrontingProfile {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_profile_shutdown: false,
        }
    }
}
pub static IS_FRONTING_PROFILE_INITIALIZED: AtomicBool = AtomicBool::new(false);
