...
// Items 1-100: MITM fronting connection diagnostics properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingConnectionDiagnostics {
    ...
    pub is_fronting_connection_diagnostics_shutdown: bool, // Item 100
}

impl MitmFrontingConnectionDiagnostics {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_connection_diagnostics_shutdown: false,
        }
    }
}
pub static IS_FRONTING_CONNECTION_DIAGNOSTICS_INITIALIZED: AtomicBool = AtomicBool::new(false);
