...
// Items 1-100: MITM fronting buffer helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingBufferHelper {
    ...
    pub is_fronting_buffer_helper_shutdown: bool, // Item 100
}

impl MitmFrontingBufferHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_buffer_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_BUFFER_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
