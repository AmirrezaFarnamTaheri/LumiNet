...
// Items 1-100: MITM fronting buffer tuning helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingBufferTuningHelper {
    ...
    pub is_fronting_buffer_tuning_helper_shutdown: bool, // Item 100
}

impl MitmFrontingBufferTuningHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_buffer_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_BUFFER_TUNING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
