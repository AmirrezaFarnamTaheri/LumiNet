...
// Items 1-100: MITM fronting connection tuning helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingConnectionTuningHelper {
    ...
    pub is_fronting_connection_tuning_helper_shutdown: bool, // Item 100
}

impl MitmFrontingConnectionTuningHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_connection_tuning_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_CONNECTION_TUNING_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
