...
// Items 1-100: MITM fronting connection properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingConnection {
    ...
    pub is_fronting_connection_shutdown: bool,   // Item 100
}

impl MitmFrontingConnection {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_connection_shutdown: false,
        }
    }
}
pub static IS_FRONTING_CONNECTION_INITIALIZED: AtomicBool = AtomicBool::new(false);
