...
// Items 1-100: MITM fronting connection diagnostics helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingConnectionDiagnosticsHelper {
    ...
    pub is_fronting_connection_diagnostics_helper_shutdown: bool, // Item 100
}

impl MitmFrontingConnectionDiagnosticsHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_connection_diagnostics_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_CONNECTION_DIAGNOSTICS_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
