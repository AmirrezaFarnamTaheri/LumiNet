...
// Items 1-100: MITM fronting connection helper properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingConnectionHelper {
    ...
    pub is_fronting_connection_helper_shutdown: bool, // Item 100
}

impl MitmFrontingConnectionHelper {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_connection_helper_shutdown: false,
        }
    }
}
pub static IS_FRONTING_CONNECTION_HELPER_INITIALIZED: AtomicBool = AtomicBool::new(false);
