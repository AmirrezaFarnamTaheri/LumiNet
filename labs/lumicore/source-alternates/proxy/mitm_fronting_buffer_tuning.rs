...
// Items 1-100: MITM fronting buffer tuning properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingBufferTuning {
    ...
    pub is_fronting_buffer_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingBufferTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_buffer_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_BUFFER_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
