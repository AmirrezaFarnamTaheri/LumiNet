...
// Items 1-100: MITM fronting connection tuning properties and structs
#[derive(Debug, Default)]
pub struct MitmFrontingConnectionTuning {
    ...
    pub is_fronting_connection_tuning_shutdown: bool, // Item 100
}

impl MitmFrontingConnectionTuning {
    pub fn new() -> Self {
        Self {
            ...
            is_fronting_connection_tuning_shutdown: false,
        }
    }
}
pub static IS_FRONTING_CONNECTION_TUNING_INITIALIZED: AtomicBool = AtomicBool::new(false);
