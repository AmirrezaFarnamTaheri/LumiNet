...
> **Authority:** Product intent and target scope, not proof of current runtime capability. For what is implemented, available, degraded, or retired now, use [`docs/current-system.md`](docs/current-system.md), live code/tests, and current route/verification surfaces.
