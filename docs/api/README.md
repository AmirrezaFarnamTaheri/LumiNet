...
> **Current route source:** See [Current API Route Registry](current-routes.md).
> This older manual is retained as payload/source material and must not be
> used as the sole authority for paths, versions, or implementation status.
